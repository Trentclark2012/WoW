 ...
 <div class="container-fluid">
  <div class="row content">
  	<div class="col-sm-12" style="text-align: center; color: black;">
  		<h1><strong style="background-color: white; padding: 0.2em;">Holy Paladin</strong></h1>
  	</div>
  
    <div class="row imgTree">
  		<div class="col-sm-3 image">
  			<center>
  				<img src="../../classes/Palidain/Palidian3.jpg" width="425" height="450" alt="Holy Paladin"/>
  			</center>
  		</div>
